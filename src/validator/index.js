...
const validator = (schema, property) => {
  return (req, res, next) => {
    ...
    console.log("test", schema.validate(req))
    console.log("test1",req[property])
    if (valid) {
      return next();
    }
    ...
    return res
      .status(500)
      .json(new HttpError(HTTP_ERROR.INTERNAL_SERVER_ERROR, "validator_wrong"));
  };
};
